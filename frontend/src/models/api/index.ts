...
export { AvailabilityClass } from './models/AvailabilityClass';
...
export type { RecoveryPointObjective } from './models/RecoveryPointObjective';
export type { RecoveryTimeObjective } from './models/RecoveryTimeObjective';
