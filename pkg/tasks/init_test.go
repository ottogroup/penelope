...
func init() {
	...
	httpMockHandler.Register(mock.GetBackUpSourceNotFoundForBigQuery, mock.GetBackUpSourceNotFoundForCloudStorage, mock.OauthHTTPMock, mock.ImpersonationHTTPMock, mock.RetrieveAccessTokenHTTPMock, mock.TablePartitionQueryHTTPMock, mock.TableInfoHTTPMock, mock.DatasetInfoHTTPMock)
