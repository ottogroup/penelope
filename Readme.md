...
- [Penelope - GCP Backup Solution](#penelope---gcp-backup-solution)
  ...
  * [API](#api)
    ...
    + [Backups](#backups)
      ...
      - [Get single backup](#get-single-backup)
      - [Update single backup](#update-single-backup)
      - [Calculates cost of single backup](#calculates-cost-of-single-backup)
    + [Buckets & Datasets](#buckets---datasets)
      - [List cloud storage buckets](#list-cloud-storage-buckets)
      - [List big query datasets](#list-big-query-datasets)
    + [Restore](#restore)
      - [List restore actions](#list-restore-actions)
    + [Tasks](#tasks)
      - [Prepare all backup jobs](#prepare-all-backup-jobs)
      - [Run new jobs](#run-new-jobs)
      - [Check all job status](#check-all-job-status)
      - [Check stuck jobs](#check-stuck-jobs)
      - [Clean up expired backup sinks](#clean-up-expired-backup-sinks)
