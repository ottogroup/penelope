...
const (
    ...
    DefaultProviderSinkForProjectPathEnv      EnvKey = "DEFAULT_PROVIDER_SINK_FOR_PROJECT_PATH"
    DefaultProviderPrincipalForUserPathEnv    EnvKey = "DEFAULT_PROVIDER_PRINCIPAL_FOR_USER_PATH"
    DefaultProviderPrincipalForProjectPathEnv EnvKey = "DEFAULT_PROVIDER_PRINCIPAL_FOR_PROJECT_PATH"
